...
Accessing the ETRADE API requires the use of authorization keys that can be obtained through the [ETRADE Developer site](https://developer.etrade.com/getting-started). To use the API, the user will need to manually log into their ETRADE account at least once a day; however, this can be automated using `RSelenium` and `Docker` as shown in this [article](https://exploringfinance.io/posts/2020-11-21-the-ultimate-dollar-cost-averaging-strategy/). 
